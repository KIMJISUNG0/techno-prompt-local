...
export const GENRE_THEMES: Record<string, GenreTheme> = {
  ...
  funkdisco: {
    id: 'funkdisco',
    gradient: 'from-pink-500 via-amber-400 to-yellow-300',
    accent: 'text-pink-200',
    glow: 'shadow-[0_0_12px_rgba(244,114,182,0.35)]',
    softBg: 'bg-pink-500/10',
  },
  funkfusion: {
    id: 'funkfusion',
    gradient: 'from-amber-500 via-purple-400 to-pink-300',
  ...
  funkrock: {
    id: 'funkrock',
    gradient: 'from-amber-500 via-red-500 to-rose-400',
    accent: 'text-red-200',
  ...
  default: {
    ...
    gradient: 'from-slate-500 via-slate-400 to-slate-300',
    accent: 'text-slate-300',
    glow: 'shadow-[0_0_10px_rgba(148,163,184,0.22)]',
    softBg: 'bg-slate-500/10',
  },
};
