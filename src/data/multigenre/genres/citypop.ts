...
export const cityPopPack: GenrePack = {
  ...
  options: [
    o('city-drum-soft-gate', 'Soft Gated Kit', 'soft gated reverb drum aesthetic', 'drums', {
      family: 'kit',
      primary: true,
    }),
    ...
    o('city-gtr-clean-chorus', 'Clean Chorus Gtr', 'clean chorus electric guitar', 'guitar', {
      family: 'clean',
      primary: true,
    }),
