...
export const countryPack: GenrePack = {
  ...
  options: [
    o('country-drum-tight-kit', 'Tight Nashville Kit', 'tight dry nashville kit', 'drums', {
      family: 'kit',
      primary: true,
    }),
    ...
    o('country-gtr-acoustic-strum', 'Acoustic Strum', 'bright steel acoustic strums', 'guitar', {
      family: 'acoustic',
      primary: true,
    }),
